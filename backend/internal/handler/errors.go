...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrBerthBusy):
		util.Fail(c, http.StatusConflict, "berth_busy", err.Error())
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrWindowVersion), errors.Is(err, service.ErrWeatherUnsafe):
